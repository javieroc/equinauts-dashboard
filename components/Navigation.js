  ...
  renderNavLinks = () => {
    ...
    if (isAuth) {
      return [
        <Menu.Item key={0}>
          <Link href="/dashboard">
            <a onClick={() => this.toggleMobileMenuOpen()}>Dashboard</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={1}>
          <Link href="/revenue">
            <a onClick={() => this.toggleMobileMenuOpen()}>Revenue</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={2}>
          <Link href="/opportunities">
            <a onClick={() => this.toggleMobileMenuOpen()}>Opportunities</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={3}>
          <Link href="/health">
            <a onClick={() => this.toggleMobileMenuOpen()}>Health</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={4}>
          <Link href="/keyinsights">
            <a onClick={() => this.toggleMobileMenuOpen()}>Key Insgihts</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={5}>
          <Link href="/profiability">
            <a onClick={() => this.toggleMobileMenuOpen()}>Profiability</a>
          </Link>
        </Menu.Item>,
        <Menu.Item key={6}>
          <Link href="/settings">
            <a onClick={() => this.toggleMobileMenuOpen()}>Settings</a>
          </Link>
        </Menu.Item>,
        isMobile && (
          <Menu.Item key={100}>
